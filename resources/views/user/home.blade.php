            ...
            <div class="swiper-wrapper wrapper">
                <div class="swiper-slide slide slide1">
                    <div class="content">
                        ...
                        <p>Vape Shop</p>
                        <a href="{{route('Menu')}}" class="btn"><span>Order Now</span></a>
                    </div>
                </div>
    ...
    <div class="popular" id="popular">
        ...
        <div class="box-container">
            ...
            <div  style="max-width:450px;" class="box">
                ...
                <h3 style="font-size: 36px;font-family: Helvetica, Arial, sans-serif;font-weight: 600;text-align: center; color: white;">{{$product->product_name}}</h3>

      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?php echo e(route('admindashboard')); ?>" class="app-brand-link">
              <span class="app-brand-text demo menu-text fw-bolder ms-2">WeSellVapes</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="<?php echo e(route('admindashboard')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="<?php echo e(route('admindashboard')); ?>">Dashboard</div>
              </a>
            </li>
            ...
            <li class="menu-item ">
              <a href="<?php echo e(route('addcategory')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Add Category</div>
              </a>
            </li>
            <li class="menu-item ">
              <a href="<?php echo e(route('allcategory')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
            ...
            <li class="menu-item ">
              <a href="<?php echo e(route('addsubcategory')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Add Sub Category</div>
              </a>
            </li>
            <li class="menu-item ">
              <a href="<?php echo e(route('allsubcategory')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
            ...
            <li class="menu-item ">
              <a href="<?php echo e(route('addproduct')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Add Product</div>
              </a>
            </li>
            <li class="menu-item ">
              <a href="<?php echo e(route('allproduct')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
            ...
            <li class="menu-item ">
              <a href="<?php echo e(route('pendingorder')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?php echo e(asset('assets/images/user_icon.png')); ?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <form action="<?php echo e(route('logout')); ?>" method="POST">
                            ...
                            <span class="align-middle"><button type="submit" style="width:100%;"><li><a  >logout</a></li></button></span>
                          </form>
                      </a>
                    </li>
                  </ul>
...
<?php /**PATH C:\xampp\htdocs\composer\ecomvape\resources\views/admin/layouts/template.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <header style="margin-bottom:200px;background-color: #000;">
        ...
        <ul class="navbar">
            ...
            <li><a href="{{route('Home')}} #Reservation" >Reservation</a></li>
            ...
            @foreach ($cart_items as $cart)
                <tr>
                    ...
                    <td data-label="Product Name">
                        <img style="height:70px;" src="{{asset($img)}}" alt="">
                    </td>
                    <td data-label="Product Name">{{$product_name}}</td>
                    <td data-label="Price">{{$cart->price}}</td>
                    <td data-label="Quantity">{{$cart->quantity}}</td>
                    <td data-label="Action"> <a href="{{route('removetocart',$cart->id)}}">Remove</a> </td>
                </tr>
                @php 
                ...
                <tr>
                    ...
                    @else
                    <td><a href="{{route('shippingaddress')}}">Checkout</a></td>
                    @endif
                </tr>
            </tbody>
        </table>

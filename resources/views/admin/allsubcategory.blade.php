                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                     ...
                     <tr>
                        ...
                        <td>
                            <a href="{{route('editsubcategory',$subcategory->id)}}" class="btn btn-outline-info">Edit</a>
                            <a href="{{route('deletesubcategory',$subcategory->id)}}" class="btn btn-outline-danger">Delete</a>
                        </td>
                     </tr>
                      @endforeach
                    </tbody>
